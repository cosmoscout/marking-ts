...
import { AnimatableData } from '../lib/interfaces/animatable-data';
...
export class AnimationGroup extends Animation {
   ...
   */
  public get running(): boolean {
    return typeof this._animations.find((animation: IAnimation): boolean => animation.running) !== 'undefined';
  }
  ...
  public remove(item: paper.Item): void {
    this._animations = this._animations.filter((animation: IAnimation): boolean => animation.target !== item);
  }
