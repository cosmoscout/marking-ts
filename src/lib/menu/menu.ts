...
import {
  filter, finalize, map, mergeMap, switchMap, takeUntil, timeoutWith,
} from 'rxjs/operators';
import MenuItem from './menu-item';
import Settings from '../settings';
import {
  ClickState, DragState, ItemState, SettingsGroup,
} from '../enums';
...
export default class Menu implements MenuData {
   ...
   */
  public init(): void {
    const root = <HTMLElement>document.querySelector(this._rootSelector);
  ...
  private setupObservables(): void {
    ...
    (<Observable<paper.MouseEvent>>fromEvent((<paper.PaperScope> this._scope).view, 'mousemove'))
      .pipe(
        map((e: paper.MouseEvent) => e.point),
    ...
    this.inputActivation$.pipe(
      mergeMap((): Observable<ClickState> => this.inputDeactivation$.pipe(
